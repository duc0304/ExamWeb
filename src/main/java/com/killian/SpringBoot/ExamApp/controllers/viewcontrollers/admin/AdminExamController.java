...
public class AdminExamController {
    ...
    public String selectSubjectAndGrade(Model model) {
        ...
        return "admin/select-subject-and-grade";
    }
    ...
    public String createExamFromBankPage(
        ...
        return "admin/create-exam-from-bank";
    }
    ...
    public String createExams(
        ...
        sessionManagementService.setMessage("Tạo đề thi tự do thành công!");
        return "redirect:/admin/exam/get-exam-by-examId?examId=" + tmp + "&selectedCode=0";
    }
    ...
    public String createExamManuallyPage(Model model) {
        model.addAttribute("message", sessionManagementService.getMessage());
        sessionManagementService.clearMessage();
        return "admin/create-exam-by-docx";
    }
    ...
    public String createExamFromDocx(@RequestParam("subject") String subject,
        ...
        List<Exam> exams = examRepository.findByNameAndOwner(name, null);
        if (!exams.isEmpty()) {
            sessionManagementService.setMessage("Tên đề thi trùng lặp");
            return "redirect:/admin/exam/create-own-exam-page";
        }
    ...
    public String removeExam(
        ...
        try {
            ...
            return "redirect:/admin/exam/get-exams-by-subject-and-grade?selectedSubject="
                    + URLEncoder.encode(selectedSubject, "UTF-8")
                    + "&selectedGrade=" + selectedGrade;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return "redirect:/admin/exam/view-exams-by-filter-page";
        }
    }
